  ...
  return (
    <div>
      ...
      <div className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <div data-aos="fade-right">
            <h2 className="text-gray-900 font-bold text-4xl mb-3">
              Chat with our team
            </h2>
            ...
            <div className="flex gap-5 items-start mb-10">
              ...
              <div>
                ...
                <a href="mailto:aptechakowonjo@gmail.com" className="text-yellow-500 text-sm hover:underline">
                  aptechakowonjo@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="flex gap-5 items-start mb-10">
              ...
              <div>
                ...
                <a   href="https://maps.app.goo.gl/cCie6uBJ3trkSF6s8"
                  target="_blank"
                  rel="noreferrer"
            ...
            <div className="flex gap-5 items-start">
              ...
              <div>
                ...
                <a href="tel:+2347026161193" className="text-yellow-500 text-sm block hover:underline">
                  +234 (0) 7026161193
                </a>
                <a href="tel:+2349115633962" className="text-yellow-500 text-sm block hover:underline">
                  +234 (0) 9115633962
                </a>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:border-primary bg-white"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  required
                  className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:border-primary bg-white resize-none"
                />
              </div>
      ...
      <div className="w-full h-[500px] mt-20">
        <iframe
          title="Aptech Akowonjo Location"
